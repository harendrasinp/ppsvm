...
const MainCard = () => {
  ...
  return (
    ...
    >
      ...
      {/* Logo Card */}
      <div className="w-full max-w-[320px] mt-13 bg-gray-300/40 flex flex-col items-center rounded-xl py-2 z-10">
      ...
      >
        ...
        >
          ...
          <p className="mt-1 text-sm font-semibold text-amber-200 px-5 ">
      ...
      <div className="w-full max-w-90 flex flex-col gap-2 px-4 z-10">
        ...
        <div className="bg-cyan-950/60 text-amber-50 rounded-2xl py-1 text-center">
          ...
          <div className="text-sm">2nd,3rd & 4th January 2026 </div>
          <div className="text-sm">4:30 PM Onwards</div>
        </div>
